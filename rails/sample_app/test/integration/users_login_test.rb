...
# Verify that a profile link appears.
  ...
  test "login with remembering" do
    ...
    assert_equal cookies['remember_token'], assigns(:user).remember_token # exercise 9.3.1.1
    # assert_not_empty cookies['remember_token'] # standard way described in book
  end
